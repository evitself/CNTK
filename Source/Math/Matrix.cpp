...
template <class ElemType>
Matrix<ElemType>& Matrix<ElemType>::InplaceLogSoftmax(const SmallVector<size_t>& sampleDimensions, const int softmaxAxis)
{
    DISPATCH_MATRIX_ON_FLAG(this,
                            this,
                            m_CPUMatrix->InplaceLogSoftmax(sampleDimensions, softmaxAxis),
                            m_GPUMatrix->InplaceLogSoftmax(sampleDimensions, softmaxAxis),
                            NOT_IMPLEMENTED,
                            NOT_IMPLEMENTED);
